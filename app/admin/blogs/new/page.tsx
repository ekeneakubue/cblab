...
export default function AdminNewBlogPage() {
  return (
    <div className="rounded-xl border border-brand-100 bg-white p-8 shadow-sm">
      <h2 className="text-lg font-semibold text-brand-900">Create blog post</h2>
      <p className="mt-2 text-sm text-brand-500">Add a new blog post. (Placeholder — form to be added)</p>
      <Link
        href="/admin/blogs"
