  ...
  return (
    <footer className="border-t border-brand-800 bg-brand-900">
      ...
      <div className="mx-auto max-w-6xl px-6 py-12 md:py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-3 text-sm leading-relaxed text-brand-200">
              Precision laboratory testing for better patient outcomes. Closing the gap between principle and practice.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-brand-200">
              <li className="inline-flex items-start gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span>22 University Road, Nsukka, Enugu State</span>
              </li>
              <li>
                <a
                  href="mailto:info@classicbiomedlab.com"
              ...
              <li>
                <a
                  href="https://wa.me/2348094493767"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 transition hover:text-white"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
        ...
        {/* Bottom bar */}
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-brand-800 pt-8 md:flex-row">
